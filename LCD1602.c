...
LCD_ShowNum(unsigned char Line,unsigned char Column,unsigned int Number,unsigned char Lenth){
	unsigned char i;
	LCD_SetCursor(Line,Column);
	for(i=Lenth;i>0;i--){
...
LCD_ShowSignedNum(unsigned char Line,unsigned char Column,int Number,unsigned char Lenth){
	unsigned char i;
